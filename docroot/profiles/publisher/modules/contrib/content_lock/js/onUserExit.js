                ...
                window.onbeforeunload = function(){
                            if (movingWithinSite == false) {
                                    if(!$.browser.chrome) {
                                          ...
                                          // Because of the Chrome bug whe have to make the AJAX call here instead of window.onunload to me sure that it goes through.
                                          // We lose the confirm message when in Chrome but we have working content locking instead.
                                          codeToExecute();
                                    }
                            }
                }
