 ...
 * Simple Exif
 */
$conf['simple_exif_exiftool_path'] = realpath(DRUPAL_ROOT . '/../lib/exiftool/exiftool');
...
// Disable rebuilding features on a cache clear. As an example, on NBC.com this
// improves drush cc all execution time by 325%. Brands should be using drush
// features-revert-all followed by a cache clear instead of relying on this
// functionality.
