...
function usa_setNotAvailableMessage() {
	if (typeof jQuery == 'undefined') {
		...
		loadScript("https://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js", function () {
			...
			jQuery('div.layout').append('<div style="width: 100%; height: 100%;z-index:2000000; position: relative;"><a href="#"><img src="http://www2.usanetwork.com/_tp/images/device_unavailable_v1.jpg" style="width:100%;height:100%;"></a></div>');
...
pdkCustomScripts.normalMetaLayoutPath = "http://www2.usanetwork.com/_tp/data/normalMetaLayout.xml";
pdkCustomScripts.smallMetaLayoutPath = "http://www2.usanetwork.com/_tp/data/smallMetaLayout.xml";
pdkCustomScripts.skinUrl = "http://www2.usanetwork.com/_tp/skin.json";

tpconfig = {
    imageRoot:"http://www2.usanetwork.com/_tp",
	disableEndcard : true,
    ...
    embedURL : "http://www.usanetwork.com/video/",
    embedWidth: "400",
    embedHeight: "225",
    autoPlay: true,
    countdown: 15,
