...
//Source: ./bower-components/angular-animate/angular-animate.js
/**
 * @license AngularJS v1.2.13
 * (c) 2010-2014 Google, Inc. http://angularjs.org
 * License: MIT
...
//Source: ./bower-components/angular-cookies/angular-cookies.js
/**
 * @license AngularJS v1.2.13
 * (c) 2010-2014 Google, Inc. http://angularjs.org
 * License: MIT
...
//Source: ./bower-components/angular-sanitize/angular-sanitize.js
/**
 * @license AngularJS v1.2.13
 * (c) 2010-2014 Google, Inc. http://angularjs.org
 * License: MIT
...
//Source: ./bower-components/angular-touch/angular-touch.js
/**
 * @license AngularJS v1.2.13
 * (c) 2010-2014 Google, Inc. http://angularjs.org
 * License: MIT
...
//Source: ./bower-components/angular-bindonce/bindonce.js
(function () {
	"use strict";
	/**
...
//Source: ./bower-components/jscrollpane/script/jquery.mousewheel.js
...
//Source: ./bower-components/jscrollpane/script/jquery.jscrollpane.js
/*!
...
//Source: ../../libraries/tve/lib/angular-bootstrap/modal.js
;
(function() {
   ...
   */
      .directive('modalBackdrop', ['$modalStack', '$timeout', function($modalStack, $timeout) {
        return {
          restrict: 'EA',
          replace: true,
          template: '<div class="tveModalBackdrop fade" ng-class="{in: animate}" ng-style="{\'z-index\': 1040 + index*10}" ng-click="close($event)"></div>',
      ...
      .directive('modalWindow', [function() {
        return {
          ...
          replace: true,
          transclude: true,
          template: '<div class="tveModalWrap"><div class="fade {{ windowClass }}" ng-class="{in: animate}" ng-style="{\'z-index\': 1050 + index*10}" ng-transclude></div></div>',
          link: function(scope, element, attrs) {
      ...
      .factory('$modalStack', ['$document', '$compile', '$rootScope', '$$stackedMap',
        function($document, $compile, $rootScope, $$stackedMap) {
          var OPENED_MODAL_CLASS = 'openModal';
          ...
          function removeModalWindow(modalInstance) {
            ...
            if (openedWindows.length() == 0) $rootScope.modalOpened = false;
          }
...
//Source: ../../libraries/tve/lib/mdetect.js
/* *******************************************
