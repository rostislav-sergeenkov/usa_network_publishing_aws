...
Drupal.settings.USA = Drupal.settings.USA || {};
Drupal.settings.USA.adobe = Drupal.settings.USA.adobeTagLoader || {};
Drupal.settings.USA.adobeTagLoader.tagContainerDC = Drupal.settings.USA.adobeTagLoader.tagContainerDC || '';
Drupal.settings.USA.adobeTagLoader.tagContainerNamespace = Drupal.settings.USA.adobeTagLoader.tagContainerNamespace || '';
Drupal.settings.USA.adobeTagLoader.tagContainerName = Drupal.settings.USA.adobeTagLoader.tagContainerName || '';

/* Adobe Tag Container Loader version: 1.0.7
Copyright 1996-2013 Adobe, Inc. All Rights Reserved
More info available at http://www.omniture.com */
var s=new TagContainerLoader();
s.tagContainerDC=Drupal.settings.USA.adobeTagLoader.tagContainerDC;
s.tagContainerNamespace=Drupal.settings.USA.adobeTagLoader.tagContainerNamespace;
s.tagContainerName=Drupal.settings.USA.adobeTagLoader.tagContainerName;
s.loadTagContainer();
