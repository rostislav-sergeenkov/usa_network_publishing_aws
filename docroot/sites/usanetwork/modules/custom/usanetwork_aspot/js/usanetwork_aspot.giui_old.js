...
(function ($) {
  ...
  Drupal.behaviors.usanetwork_aspot_giui = {
    ...
    initAspot: function (prefix, block, second_block, draggableId, pageName) {
      ...
      function setPositionDraggableElement(elem, direction, step) {
      ...
      function usanetwork_aspot_giui_setup_draggable_elements() {
        ...
        carouselElementPreviewingBlock
            ...
            .after('<div class="buttons-wrapper">' +
                ...
                '<span class="field-font-size" data-default-font-size="" data-font-size-step="' + defaultFontSize.desktop.title_prefix.step + '" data-step-counter=""></span>' +
                '<button class="increase-font font-button">+</button>' +
                '</div>' +
                '<div class="edit-field-size" data-field-name="title">' +
                '<span class="name">Title</span>' +
                '<button class="decrease-font font-button">-</button>' +
                '<span class="field-font-size" data-default-font-size="" data-font-size-step="' + defaultFontSize.desktop.title.step + '" data-step-counter=""></span>' +
                '<button class="increase-font font-button">+</button>' +
                '</div>' +
                '<div class="edit-field-size" data-field-name="aspot_description">' +
                '<span class="name">Description</span>' +
                '<button class="decrease-font font-button">-</button>' +
                '<span class="field-font-size" data-default-font-size="" data-font-size-step="' + defaultFontSize.desktop.aspot_description.step + '" data-step-counter=""></span>' +
                '<button class="increase-font font-button">+</button>' +
                '</div>' +
                '</div>'
            );
        ...
        carouselElementPreviewingBlockMobile
            ...
            .after('<div class="buttons-wrapper">' +
                ...
                '<h2>Change font size</h2>' +
                '<div class="edit-field-size" data-field-name="title_prefix">' +
                '<span class="name">Title prefix</span><button class="decrease-font font-button">-</button>' +
                '<span class="field-font-size" data-default-font-size="" data-font-size-step="' + defaultFontSize.mobile.title_prefix.step + '" data-step-counter=""></span>' +
                '<button class="increase-font font-button">+</button>' +
                '</div>' +
                '<div class="edit-field-size" data-field-name="title">' +
                '<span class="name">Title</span><button class="decrease-font font-button">-</button>' +
                '<span class="field-font-size" data-default-font-size="" data-font-size-step="' + defaultFontSize.mobile.title.step + '" data-step-counter=""></span>' +
                '<button class="increase-font font-button">+</button>' +
                '</div>' +
                '<div class="edit-field-size" data-field-name="aspot_description">' +
                '<span class="name">Description</span><button class="decrease-font font-button">-</button>' +
                '<span class="field-font-size" data-default-font-size="" data-font-size-step="' + defaultFontSize.mobile.aspot_description.step + '" data-step-counter=""></span>' +
                '<button class="increase-font font-button">+</button>' +
                '</div>' +
                '</div>'
            );
