        ...
        <div class="meta-wrap">
          <div class="meta">
            <div class="title_prefix aspot-draggable-element
              <?php print (!empty($show_title_prefix_style['fonts']['desktop']) ? 'font-desktop-show-' . $show_title_prefix_style['fonts']['desktop'] : ''); ?>
              <?php print (!empty($show_title_prefix_style['fonts']['mobile']) ? 'font-mobile-show-' . $show_title_prefix_style['fonts']['mobile'] : ''); ?>"
            ...
            <div class="title aspot-draggable-element
              <?php print (!empty($show_title_style['fonts']['desktop']) ? 'font-desktop-show-' . $show_title_style['fonts']['desktop'] : ''); ?>
              <?php print (!empty($show_title_style['fonts']['mobile']) ? 'font-mobile-show-' . $show_title_style['fonts']['mobile'] : ''); ?>"
            ...
            <div class="aspot-description aspot-draggable-element
              <?php print (!empty($show_description_style['fonts']['desktop']) ? 'font-desktop-show-' . $show_description_style['fonts']['desktop'] : ''); ?>
              <?php print (!empty($show_description_style['fonts']['mobile']) ? 'font-mobile-show-' . $show_description_style['fonts']['mobile'] : ''); ?>"
