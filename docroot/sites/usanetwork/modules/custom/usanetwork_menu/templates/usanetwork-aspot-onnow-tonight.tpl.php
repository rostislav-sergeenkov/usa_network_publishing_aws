<div class="schedule-on-tonight">
              ...
              <div class="episode-info">
                ...
                <div class="icons-block">
                  ...
                  <?php if (!empty($on_now_block_item['up_next']['syndicated_url'])): ?>
                    <a class="calendar-reminder seeit-reminder icon no-link" data-name="reminder" href="javascript:void(0)"
  ...
  <div class="schedule-buttons on-tonight">
    <a class="on-now no-link" data-class="on-now" href="#" ><span><?php print t('On now'); ?></span></a>
    <a class="on-tonight no-link disabled active" data-class="on-tonight" href="#">
