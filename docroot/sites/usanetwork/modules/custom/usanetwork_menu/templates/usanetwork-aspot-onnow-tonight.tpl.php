          ...
          <div class="schedule-item">
            ...
            <div class="episode-info">
              <?php if (!empty($on_now_block_item['on_now']['show_title']) && !empty($on_now_block_item['on_now']['episode_title'])): ?>
                <div class="episode-show<?php print !empty($on_now_block_item['on_now']['episode_class']) ? (' ' . $on_now_block_item['on_now']['episode_class']) : ''; ?>">
                  <div class="episode-show-wrapper">
                    <?php print $on_now_block_item['on_now']['show_title']; ?><br><?php print $on_now_block_item['on_now']['episode_title']; ?>
                  </div>
                </div>
              <?php endif; ?>
      ...
      <?php if (!empty($tonight_block_items)): ?>
        <?php foreach ($tonight_block_items as $tonight_block_item): ?>
          <div class="schedule-item">
            ...
            <div class="episode-info">
              <div class="episode-show<?php print !empty($tonight_block_item['episode_class']) ? (' ' . $tonight_block_item['episode_class']) : ''; ?>">
                <div class="episode-show-wrapper">
