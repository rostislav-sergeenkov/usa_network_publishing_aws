 ...
 */
?>
<div class="about-show-block show-border <?php print !empty($about_image) || !empty($about_text) ? 'about-show-enable' : ''; ?>">
  <?php if (!empty($about_image) || !empty($about_text)): ?>
    <div class="about-show-block-inner">
      ...
      <?php if (!empty($about_text)): ?>
        <div class="about-show-text-block">
          <div
            class="about-show-text-block-title"><?php print t('About the show'); ?></div>
          <div
            class="about-show-text-block-description"><?php print $about_text; ?></div>
          <div class="about-show-text-block-more">
            <a href="<?php print (!empty($url)) ? $url : '#'; ?>"
               class="show-color hover-avail"><?php print t('read more'); ?></a>
          </div>
        </div>
      <?php endif; ?>
