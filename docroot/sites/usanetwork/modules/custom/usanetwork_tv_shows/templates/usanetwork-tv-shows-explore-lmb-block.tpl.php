 ...
 */
?>
<div class="landing-main-block show-explore-landing-main-block five-promo-item-block show-border">
  <?php if (!empty($promos) && is_array($promos)):?>
    <ul>
      <?php foreach ($promos as $promo): ?>
        ...
        <?php else: ?>
          <li>
            <div class="node node-usanetwork-promo usanetwork-tv-shows-explore-lmb<?php if (!empty($promo['class'])) : print ' ' . $promo['class']; endif; ?>">
              <a href="<?php print (!empty($promo['url']))? $promo['url']: '#'; ?>">
                <div class="meta-wrapper">
                  <div class="meta-wrapper-inner">
                    <div class="meta-icon <?php print (!empty($promo['icon_type']))? $promo['icon_type']: ''; ?>"></div>
