 ...
 */
?>
<div class="node node-usanetwork-promo big <?php print (!empty($is_new_design))? 'usa-landing-container-promo': 'three-line-video-large'; ?><?php if (!empty($classes)): print ' ' . $classes; endif; ?><?php if (!empty($custom_classes)): print ' ' . $custom_classes; endif; ?>">
