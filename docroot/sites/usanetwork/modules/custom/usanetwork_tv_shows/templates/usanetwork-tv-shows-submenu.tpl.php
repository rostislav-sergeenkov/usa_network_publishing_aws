<div class="show-title-block-wrapper show-border secondary">
  <div class="show-title-block show-color">
    <div class="menu-open show-border secondary"><a href="javascript:void(0)" class="link-color-reset"></a></div>
    <div class="schedule">
...
<div class="show-menu-tab" style="display: none;">
  ...
  <ul class="show-menu menu">
    ...
    foreach ($show_menu_tab_items as $show_menu_tab_item):
      ?>
      <li class="<?php if (isset($show_menu_tab_item['child']) && count($show_menu_tab_item['child']) > 0): ?>expanded<?php endif; ?> <?php if ($i == 0): ?> active<?php endif; ?>"><?php print $show_menu_tab_item['main_link']; ?>
