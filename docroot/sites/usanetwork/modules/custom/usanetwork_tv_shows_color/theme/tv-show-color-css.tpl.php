...
.show-<?php print $node_code; ?> .show-color {
  background: <?php print $primary_color_code; ?>;
}
.show-<?php print $node_code; ?> .show-color.secondary {
  background: <?php print $secondary_color_code; ?>;
}
.show-<?php print $node_code; ?> .show-color.secondary:before {
  background: <?php print $tertiary_color_code; ?>;
}
.show-<?php print $node_code; ?> .show-color.tertiary {
  background: <?php print $tertiary_color_code; ?>;
}
.show-<?php print $node_code; ?> .show-color.tertiary:before {
  background: <?php print $secondary_color_code; ?>;
}
.show-<?php print $node_code; ?> .show-color.hover-avail:hover {
  background: <?php print $tertiary_color_code; ?>;
}
