...
NBCUEndShareCard.BuildNewEndCard = function(){
	...
	var p2 = $('<div class="socialp1wrap"><g:plusone annotation="none" href=""></g:plusone></div>'); socialButtons.append(p2);
	...
	if (NBCUEndShareCard.Feed != "") {
		var ymalHeading = $('<div class="endcardymalheading">You may also like:</div>'); endCardInner.append(ymalHeading);
	}
