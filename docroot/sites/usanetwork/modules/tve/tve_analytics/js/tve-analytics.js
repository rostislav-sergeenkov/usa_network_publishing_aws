...
(function($, s, window) {
  ...
  function authzTrack(status, selectedProvider) {
    ...
    _trackEvent('', 'Pass:Authorize:' + (status ? 'Success' : 'Fail'), 'contextData.tve_passauthorizefail,contextData.tve_passauthorizesuccess,contextData.tve_passguid,contextData.tve_passmvpd,contextData.tve_passnetwork,contextData.tve_passauthorize');
    $.cookie(AUTH_COOKIE_NAME, '1');
  }

  function trackAuthEvents(eventType, args) {
    _preProcess();
    ...
    switch (eventType) {
      ...
      case events.MVPD_SELECTED:
        ...
        _trackEvent('', args.mvpd_id + ' Selected', 'contextData.tve_passselected,contextData.tve_passmvpd,contextData.tve_passnetwork');
      ...
      case events.AUTHN_TRACK:
        ...
        if (args.authnStatus == 'Authenticated') {
          ...
          _trackEvent('', 'Pass:Authenticate:Success', 'contextData.tve_passauthensuccess,contextData.tve_passguid,contextData.tve_contenthub,contextData.tve_passauthen,contextData.tve_passmvpd');
        }
        else {
          s.contextData['tve_passauthenfail'] = 'true';
          _trackEvent('', 'Pass:Authenticate:Fail', 'contextData.tve_passauthenfail,contextData.tve_contenthub,contextData.tve_passauthen,contextData.tve_passmvpd');
        }
