...
if (typeof jQuery == 'undefined' || jQuery.fn.jquery != "1.7.1") {
  ...
  // JQUERY
  window.USAGlobalNav.jQuery = jQuery.noConflict(true);
} else {
  window.USAGlobalNav.jQuery = jQuery;
}
  ...
  $.jPanelMenu = function (options) {
    ...
    var jP = {
      ...
      closeMenu: function (animated) {
        ...
        if (animationChecks.transitions || animationChecks.none) {
          ...
          jP.timeouts.afterClose = setTimeout(function () {
            jP.setPanelStyle({
              position: jP.settings.panelPosition
            });
            jP.disableTransitions();
            if (jP.settings.shiftFixedChildren) {
              $(jP.fixedChildren).each(function () {
            ...
            jP.hideMenu();
            $('body > ' + jP.panel).css('display', 'none');
            jP.options.after();
      ...
      setupMarkup: function () {
        ...
        $('body').prepend('<div class="' + jP.panel.replace('.', '') + '"/>');
        $('body > ' + jP.panel).css('display', 'none');
      ...
      setPosition: function (newPosition) {
        if (typeof (newPosition) == "undefined" || newPosition == null) {
          newPosition = jP.options.openPosition
        };
      ...
      setDirection: function (newDirection) {
        if (typeof (newDirection) == "undefined" || newDirection == null) {
          newDirection = jP.options.direction
        };
...
function menu_init(){
  (function($) {
    ...
    var $personalization_drawer = $('#personalization-panel').clone();
    ...
    var $wrapper = $('#inner-on-now-panel .tab-wrapper');
