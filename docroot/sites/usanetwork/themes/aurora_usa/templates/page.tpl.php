    ...
    <div id="content" role="article" class="column">
      ...
      <div class="best-of-block show-border">
        <h2 class="section-title">
          <span class="section-title-wrapper show-border secondary">
            Best of chrisley
          </span>
        </h2>
        <ul>
          <li class="first">
            <div class="node node-usanetwork-promo featured-large">
              <a href="/psych/videos/psych-out-nightmare">
                ...
                <div class="asset-img">
                  <img src="http://dev.usanetwork.com/sites/usanetwork/files/styles/757x628/public/media-mpx/2755067.jpg?itok=KEG9ln-o" width="757" height="628" alt="">    </div>
              </a>
            </div>
          </li>
          <li class="last">
            <div class="node node-usanetwork-promo three-line-video">
              <a href="/whitecollar/videos/season-6-interview-willie-garson">
                <div class="meta-wrapper">
                  <div class="meta-wrapper-inner">
                    <div class="meta">
                      <div class="caption"></div>
                ...
                <div class="asset-img">
                  <img src="http://dev.usanetwork.com/sites/usanetwork/files/styles/539x303/public/media-mpx/2816750.jpg?itok=Lxc3UBnu" width="539" height="303" alt="">    </div>
              </a>
            </div>

            <div class="node node-usanetwork-promo three-line-video">
              <a href="/sirens/videos/preview-all-the-single-ladies">
                <div class="meta-wrapper">
                  <div class="meta-wrapper-inner">
                    <div class="meta">
                      <div class="caption"></div>
                ...
                <div class="asset-img">
                  <img src="http://dev.usanetwork.com/sites/usanetwork/files/styles/539x303/public/media-mpx/2845786.jpg?itok=tjJigvjC" width="539" height="303" alt="">    </div>
              </a>
            </div>
            <div class="node node-usanetwork-promo three-line-video">
              <a href="/benched/videos/">
                <div class="meta-wrapper">
                  <div class="meta-wrapper-inner">
                    <div class="meta-icon video-icon"></div>
                    <div class="meta">
                      <div class="caption">tester's test</div>
                      <div class="title">TEST</div>
                      <div class="additional">gjdl j:JF: testjt jgdj gtest ljldgj dkjg:)ET(R )S D:OV{P+)@$_#)%(T* IGk</div>
                    </div>
                  </div>
                </div>
                <div class="asset-img">
                  <img src="http://dev.usanetwork.com/sites/usanetwork/files/styles/539x303/public/promo_regular/benched_promo_previewClips_600x500.jpg?itok=Hj3Mt2K9" width="539" height="303" alt="">    </div>
              </a>
              TEST  </div>
            <div class="node node-usanetwork-promo three-line-video">
              <a href="/benched/videos/">
