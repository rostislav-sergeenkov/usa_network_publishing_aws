...
<div class="full-pane">
  ...
  <?php if (!empty($videos)): ?>
    <div id="block-usanetwork-mpx-video-usa-mpx-video-views"
         class="block block-usanetwork-mpx-video">
      <div class="content">
        <div class="ajax-content">
          ...
          <div id="thumbnail-list"
                ...
                <ul>
                  ...
                  foreach ($videos as $v_key => $video): ?>
                    <?php if (!empty($video['url']) && !empty($video['rendered'])): ?>
                      <li
                        class="thumbnail views-row grid-item <?php print $video['state']; ?>"
            ...
            <div
              class="expandable-toggle-wrap <?php if (!empty($more_videos)): ?>active<?php endif; ?>">
