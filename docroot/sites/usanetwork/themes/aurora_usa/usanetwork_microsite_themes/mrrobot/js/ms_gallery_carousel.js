  ...
  Drupal.behaviors.microsite_gallery_carousel = {
    updateGigyaSharebarOmniture: function($slider, initialPageLoad) {
      ...
      if (typeof Drupal.gigya != 'undefined') {
        ...
        var $sharebar = $slider.parents('.full-pane').find('.field-name-field-gigya-share-bar > div');
        if ($sharebar.length > 0) {
          var $title = $slider.parents('.full-pane').find('.microsite-gallery-meta h2.gallery-title').text();
          ...
          var url = $('.bxslider li.active a').attr('href');
          ...
          if (!initialPageLoad) {
            ...
            s.prop3 = 'Don\'t Bother Me';
            s.prop4 = siteName + ' : Don\'t Bother Me';
            s.prop5 = siteName + ' : Don\'t Bother Me : ' + $title;
            s.pageName = s.prop5 + ' : Photo ' + currentSlide;
            document.title = $title + ' | Don\'t Bother Me | ' + basePageName;
