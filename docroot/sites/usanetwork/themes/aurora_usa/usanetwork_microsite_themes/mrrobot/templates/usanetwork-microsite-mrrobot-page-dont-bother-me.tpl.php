...
<?php //if (!empty($section_title)): ?>
  <!-- section title -->
  <h2 class="content">&lt;don't bother me&gt;</h2>
<?php //endif; ?>

<?php //if (!empty($description)): ?>
  <!-- section description -->
  <div class="section-description">Let everyone know not to bother you while you watch Mr. Robot</div>
<?php //endif; ?>

<div class="full-pane clearfix">
  <div id="dbm-image-viewer" style="width: calc(100% - 320px); padding-top: 100%; background-color: #222"></div>
  <div id="dbm-image-nav" style="width: 300px; margin-left: 20px; background-color: #222"></div>
<?php /* ?>
