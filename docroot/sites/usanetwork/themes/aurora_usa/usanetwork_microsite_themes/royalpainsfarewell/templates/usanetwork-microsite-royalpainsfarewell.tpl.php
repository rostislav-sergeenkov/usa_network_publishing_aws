    ...
    <?php foreach ($sections as $section): ?>
      <?php if ((!empty($section['content']) || $section['type'] == 'about') && !empty($section['type'])): ?>
        ...
        <?php if ($section['type'] == 'timeline'): ?>
          <div id="farewell-social" class="section">
            <a name="farewell-social"></a>
            <section id="farewell-social-content" class="clearfix fadein fadein-1s fadein-delay-1s">

              <div class="section-title-block">
                <!-- section title -->
                <h2 class="content">Social</h2>

                <div class="section-description">
                  <p>Say goodbye to Royal Pains and share your favorite moments</p>
                </div>
              </div>

              <div id="social-content">
                <div class="mr-space" id="mr-space_royalpains-farewell-social-space" data-space-id="usa-network/royalpains-farewell-social-space" style="min-height: 500px;"></div>
              ...
              <div id="ms-farewell-social-leaderboard-ad" class="midbanner ad-leaderboard"></div>
            </section>
          </div>
        <?php endif; ?>
      <?php endif; ?>
