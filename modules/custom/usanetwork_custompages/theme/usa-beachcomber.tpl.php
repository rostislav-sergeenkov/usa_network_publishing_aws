...
<div id="usa_noflash"><img src="<?php echo "/".$image_path;?>royalpains_flash_sorry.png"></div>
  	<script type="text/javascript">
		...
		swfobject.embedSWF("<?php echo $base_url."/".$swf_path;?>RP_beachcomber21.swf", "usa_noflash", "739", "766", "8", "swf/expressInstall.swf", flashvars, params, attributes);
