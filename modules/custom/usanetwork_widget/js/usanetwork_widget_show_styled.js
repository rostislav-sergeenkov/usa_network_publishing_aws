...
var url = "http://origin.stage.usanetwork.com/node/" + $show_id + "/navbar/syndicate_styled?test111";
...
if(typeof $show_id != 'undefined') {
  document.write('<script src="http://origin.stage.usanetwork.com/sites/usanetwork/themes/aurora_usa/javascripts/main-navigation-syndicate.js?test1"></script>');
  if(isIE9) { 
