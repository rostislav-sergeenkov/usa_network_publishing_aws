...
/**
 * @file
 * Advanced authsource configurations.
 */
...
include_once DRUPAL_ROOT . '/profiles/publisher/modules/custom/pub_sso/lib/authsources.inc';

// The environment-appropriate authentication source is added below.
...
$config[$environment_config['authentication-source.key']] = array(
  'saml:SP',
  'entityID' => $environment_config['entityID'],
  'idp' => $environment_config['idp'],
  'discoURL' => NULL,
);

if ($environment_info['dynamic_domains']) {
  $config[$environment_config['authentication-source.key']] += array(
    'privatekey' => $environment_config['private.key'],
    'certificate' => $environment_config['public.key'],
    'signature.algorithm' => 'http://www.w3.org/2001/04/xmldsig-more#rsa-sha256',
    'redirect.sign' => TRUE,
