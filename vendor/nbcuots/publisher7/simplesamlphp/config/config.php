 ...
 */
include_once dirname(__FILE__) . '/../../sso/config.inc';
...
$config = array (
	 ...
	 * reverse proxy).
	 */
	'baseurlpath'           => $environment_config['baseurlpath'],
	'certdir'               => $environment_config['certdir'],
	'loggingdir'            => $environment_config['loggingdir'],
	'datadir'               => '/var/log/',
	 ...
	 */
	'showerrors'     =>	$environment_config['showerrors'],
	'errorreporting' =>	TRUE,
	 ...
	 */
	'auth.adminpassword'		=> $environment_config['auth.adminpassword'],
	 ...
	 */
	'technicalcontact_name'  => $environment_config['technicalcontact_name'],
	'technicalcontact_email' => $environment_config['technicalcontact_email'],
	 ...
	 * 
	 */
	'logging.level'   => $environment_config['logging.level'],
  ...
  'store.type' => $environment_config['store.type'],
  ...
  'store.sql.dsn' => $environment_config['store.sql.dsn'],
  'store.sql.username' => $environment_config['store.sql.username'],
  'store.sql.password' => $environment_config['store.sql.password'],
  'store.sql.prefix' => $environment_config['store.sql.prefix'],
	 ...
	 */
	'proxy' => $environment_config['proxy'],
